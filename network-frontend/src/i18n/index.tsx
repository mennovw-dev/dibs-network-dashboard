...
const nl: Dict = {
  ...
  'settings.data': 'Live data',
  'settings.open': 'Instellingen openen',
  'time.enable': 'Bekijk in de tijd',
  'time.disable': 'Terug naar live',
  'view.map2d': "Bird's-eye (2D)",
  'view.map3d': '3D-perspectief',
...
const en: Dict = {
  ...
  'time.enable': 'View over time',
  'time.disable': 'Back to live',
  'view.map2d': "Bird's-eye (2D)",
  'view.map3d': '3D perspective',
